                    ...
                    <div className="workTime">
                        {infoState.is_open ? (
                            <div>
                                Radno vrijeme:
                                <div className="days">
                                    {days[infoState.day_from][currentLang]} -{' '}
                                    {days[infoState.day_to][currentLang]}
                                </div>
                                <div className="time">
                ...
                <section id="about">
                    ...
                    <div className="aboutus-box">
                        ...
                        <p className="randomtext">
                            ...
                            elit. Sequi non rem aliquid accusantium aliquam
                            quasi cupiditate quam provident rerum fuga,
                            consequatur delectus sapiente nam praesentium nihil
                            voluptates asperiores numquam atque eveniet culpa
                            totam impedit! Dignissimos sapiente inventore est,
                            ipsum ab atque in aspernatur eligendi voluptatum
                            error exercitationem expedita nobis sint numquam
                            enim aut praesentium pariatur, ex at accusamus!
                            Perferendis mollitia quis aliquid quidem temporibus
                            est eveniet quisquam obcaecati, saepe rerum modi
                            repellendus rem. Ea hic eum obcaecati quia dolor,
                            minus quas illo corporis ipsa debitis nam inventore
                            fugiat dolorum dolores perferendis neque facere
                            soluta vero maxime eligendi numquam accusamus.
                            Itaque?
                        </p>
                    ...
                    <div className="friendly-box">
                        ...
                        <div className="icon">
                            ...
                            <p className="icon-text">Lorem, ipsum.</p>
                        </div>
                        <div className="icon">
                            <svg
                                focusable="false"
